...
ResourceType.create(resource_class: 'RDS', name: 'RDS', parents_list: "Rails" , small_icon: "amazon/AWS_Simple_Icons_Database_Amazon_RDS.svg", large_icon: "amazon/AWS_Simple_Icons_Database_Amazon_RDS.svg", description: 'Relational Database Service')
...
ResourceType.create(resource_class: 'EC2', name: 'Mysql', parents_list: "Rails" , small_icon: "components/mysql.svg", large_icon: "components/mysql.svg", description: 'MySQL database server')
