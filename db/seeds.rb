...
ResourceType.create(name: 'Mysql', small_icon: "components/mysql.svg", large_icon: "components/mysql.svg")
ResourceType.create(name: 'Nginx', small_icon: "components/nginx.svg", large_icon: "components/nginx.svg")
